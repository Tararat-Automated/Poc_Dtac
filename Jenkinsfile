            ...
            steps {
                parallel (
                    ...
                    "iOS-2": {
                        ...
                        pybot -d Result -v ar_OS:iOS -v ar_Porturl:http://localhost:8201/wd/hub -v ar_pfversion:13.5 -v ar_devicename:D4779DBC-AB3A-4208-9B79-79C5B017E775 DtacDemo.robot
                        echo 'Finish testing iOS..'
                        '''
                    },
                    "Android-1": {
