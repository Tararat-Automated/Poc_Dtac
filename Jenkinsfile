            ...
            steps {
                parallel (
                    "iOS-1": {
                        ...
                        pybot -d Result/iOS -v ar_OS:iOS -v ar_Porturl:http://localhost:8200/wd/hub -v ar_pfversion:13.2 -v ar_devicename:IPhone 11 DtacDemo.robot
                    ...
                    "iOS-1": {
                        ...
                        sleep 5s
                        echo 'Running test for iOS 1..'
                        pybot -d Result/iOS -v ar_OS:iOS -v ar_Porturl:http://localhost:8201/wd/hub -v ar_pfversion:13.6 -v ar_devicename:IPhone 11 DtacDemo.robot
                        echo 'Finish testing iOS..'
                        '''
                    },
                    "Android-1": {
